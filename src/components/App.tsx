            ...
            <nav className="fixed w-full z-40 bg-[#030308]/60 backdrop-blur-xl border-b border-white/5">
                <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex gap-8 text-sm font-medium text-gray-400">
                        <a href="/features#problem" className={`hover:text-white transition-colors ${page === 'features' ? 'text-white' : ''}`}>Problem</a>
                        <a href="/#how-it-works" className={`hover:text-white transition-colors ${page === 'home' ? 'text-white' : ''}`}>How It Works</a>
                        <a href="/features#features" className={`hover:text-white transition-colors ${page === 'features' ? 'text-white' : ''}`}>Features</a>
                        <a href="/features#compliance" className={`hover:text-white transition-colors ${page === 'features' ? 'text-white' : ''}`}>Compliance</a>
                        <a href="/contact" className={`hover:text-white transition-colors ${page === 'contact' ? 'text-white' : ''}`}>Contact Options</a>
                    </div>
            ...
            <footer className="pt-24 pb-10 px-6 border-t border-white/5 bg-[#030308] relative z-10">
                ...
                <div className="max-w-7xl mx-auto border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 md:gap-8 text-sm font-medium text-gray-500">
                        <a href="/features#problem" className="hover:text-white transition-colors">Problem</a>
                        <a href="/#how-it-works" className="hover:text-white transition-colors">How It Works</a>
                        <a href="/features#features" className="hover:text-white transition-colors">Features</a>
                        <a href="/features#compliance" className="hover:text-white transition-colors">Compliance</a>
