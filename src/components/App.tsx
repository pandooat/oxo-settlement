                    ...
                    <section className="py-12 border-y border-white/5 bg-[#05050A]">
                        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 opacity-80 hover:opacity-100 transition-all duration-500">
                            ...
                            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                                {/* Bitcoin */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-white/5 flex items-center justify-center saturate-[0.8]">
                                ...
                                {/* Ethereum */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-white/5 flex items-center justify-center saturate-[0.8] opacity-90">
                                ...
                                {/* Base */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-[#0052FF]/30 flex items-center justify-center relative overflow-hidden saturate-[0.8] opacity-90 shadow-[0_0_15px_rgba(0,82,255,0.1)]">
                                    <div className="absolute inset-0 bg-[#0052FF]/80" />
                                    <div className="absolute w-8 h-8 rounded-full bg-[#101014] opacity-40 -top-2 -right-2 filter blur-md" />
                                    <div className="absolute w-6 h-6 rounded-full bg-[#101014] opacity-90 top-1.5 left-1.5" style={{ boxShadow: 'inset -2px -2px 5px rgba(0,0,0,0.5)' }} />
                                </div>
                                {/* Polygon */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-white/5 flex items-center justify-center saturate-[0.8] opacity-90">
