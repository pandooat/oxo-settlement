                    ...
                    <section className="py-12 border-y border-white/5 bg-[#05050A]">
                        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 opacity-80 hover:opacity-100 transition-all duration-500">
                            ...
                            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                                {/* Bitcoin */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-white/10 flex items-center justify-center shadow-[0_4px_12px_rgba(247,147,26,0.15)] group hover:border-[#F7931A]/50 transition-colors">
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="16" cy="16" r="16" fill="#F7931A" /><path d="M22.84 14.18c.35-2.31-1.35-3.55-3.64-4.32l.74-2.98h0l-1.81-.45h0l-.73 2.92c-.47-.12-.96-.23-1.45-.34l.74-2.96h0l-1.8-.45h0l-.73 2.93a40.09 40.09 0 0 0-1.15-.27L11.4 8l-.34 1.34s.92.21.9.23c.5.12.59.46.58.72l-.58 2.34h0l-.58 2.33c-.05.13-.19.33-.53.24.01.02-.9-.23-.9-.23l-.62 1.45 1.7.42c.45.11.9.23 1.35.33l-.75 3h0l1.81.45h0l.74-2.97c.5.13 1 .25 1.48.36l-.75 3h0l1.81.45h0l.76-3.03c3.1.59 5.43.35 6.42-2.45.8-2.24-.04-3.54-1.63-4.38 1.15-.27 2.02-1.02 2.27-2.38l.02-.01Zm-3.57 5.09c-.58 2.34-4.5.8-5.78.48l1.03-4.13c1.28.32 5.37.95 4.75 3.65Zm.53-6.53c-.53 2.14-3.8.78-4.85.52l.93-3.75c1.06.26 4.49.77 3.92 3.23Z" fill="#101014" /></svg>
                                </div>
                                {/* Ethereum */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-white/10 flex items-center justify-center shadow-[0_4px_12px_rgba(98,126,234,0.15)] group hover:border-[#627EEA]/50 transition-colors">
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="16" cy="16" r="16" fill="#627EEA" /><path d="M15.82 4l-7.39 12.23 7.39 4.36Z" fill="#C0CBF6" /><path d="M15.82 4v16.59l7.39-4.36Z" fill="#101014" /><path d="M15.82 22l-7.39-4.31 7.39 10.31Z" fill="#C0CBF6" /><path d="M15.82 28V22l7.39-4.31Z" fill="#8197DF" /></svg>
                                </div>
                                {/* Solana */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-white/10 flex items-center justify-center shadow-[0_4px_12px_rgba(0,255,163,0.15)] group hover:border-[#00FFA3]/50 transition-colors">
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="16" cy="16" r="16" fill="#101014" /><path d="M8 12.5h11.83c.31 0 .61-.13.82-.36l2.12-2.29a.44.44 0 0 0-.32-.75H10.63c-.3 0-.6.13-.8.36L7.7 11.75a.44.44 0 0 0 .31.75Zm16 2.6H12.16c-.3 0-.6.13-.8.36l-2.12 2.3a.44.44 0 0 0 .32.74h12.16c.3 0 .6-.13.82-.36l2.12-2.3a.44.44 0 0 0-.32-.74Zm0 6.1H12.16c-.3 0-.6.13-.8.36l-2.12 2.3a.44.44 0 0 0 .32.74h12.16c.3 0 .6-.13.82-.36l2.12-2.3a.44.44 0 0 0-.32-.74Z" fill="url(#sol_grad_alt)" /><defs><linearGradient id="sol_grad_alt" x1="5%" y1="0%" x2="95%" y2="100%"><stop stopColor="#00FFA3" offset="0%" /><stop stopColor="#DC1FFF" offset="100%" /></linearGradient></defs></svg>
                                </div>
                                {/* Base */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-[#0052FF]/40 flex items-center justify-center relative overflow-hidden shadow-[0_4px_16px_rgba(0,82,255,0.25)] group hover:border-[#0052FF]/70 transition-colors">
                                    <div className="absolute inset-0 bg-[#0052FF]" />
                                    <div className="absolute w-8 h-8 rounded-full bg-[#101014] opacity-20 -top-2 -right-2 filter blur-sm" />
                                    <div className="absolute w-6 h-6 rounded-full bg-[#101014] top-1.5 left-1.5" style={{ boxShadow: 'inset -2px -2px 5px rgba(0,0,0,0.4)', opacity: 0.95 }} />
                                </div>
                                {/* Polygon */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-white/10 flex items-center justify-center shadow-[0_4px_12px_rgba(130,71,229,0.15)] group hover:border-[#8247E5]/50 transition-colors">
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22.09 18.25V12.9a1.9 1.9 0 0 0-.96-1.66l-4.52-2.61a1.94 1.94 0 0 0-1.93 0L10.16 11.19c-1 .59-1.95 1.13-1.93 2.27v4.61a1.93 1.93 0 0 0 .96 1.66l4.52 2.61c.6.35 1.33.35 1.93 0l4.52-2.61c.6-.34.96-.93.96-1.62-.03.14-.03-.22-.03.14Zm-4.83 1.37-3.23-1.87v-3.72l3.23-1.86 3.22 1.86v3.74L17.26 19.62Z" fill="#8247E5" /><path d="M12.91 23.36V18a2.12 2.12 0 0 0 1-1.82v-3.76L17 10.64a1.05 1.05 0 0 1 1 0l3.05 1.76v3.31l1.82 1.04v-4.9a1.88 1.88 0 0 0-.94-1.6l-4.23-2.44a1.88 1.88 0 0 0-1.86 0l-4.24 2.45a1.88 1.88 0 0 0-.93 1.6V16.6l-2.01-1.16v-3.5L10.51 10.9v-2.1L8.2 9.92a1.88 1.88 0 0 0-.94 1.62v4.9a1.86 1.86 0 0 0 .94 1.6zM22.8 20l1.88-1.09a1.88 1.88 0 0 0 .93-1.63v-4.9a1.81 1.81 0 0 0-.94-1.57v2.1l-1.87 1.07v3.52l1.55.9-.6.34L20.69 20.6A1.06 1.06 0 0 1 19.64 20.6l-3.04-1.76v-3.32l-1.82-1.04v4.91c0 .66.35 1.28.94 1.62l4.23 2.44a1.9 1.9 0 0 0 1.85 0" fill="#8247E5" /></svg>
                                </div>
                                {/* Binance */}
                                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-[10px] bg-[#101014] border border-white/10 flex items-center justify-center shadow-[0_4px_12px_rgba(243,186,47,0.15)] group hover:border-[#F3BA2F]/50 transition-colors">
                                    <svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.95 14L16 9.95 20.05 14l3.19-3.2L16 3.56l-7.23 7.24L11.95 14Zm4.05 8.04L11.95 18 8.76 21.2 16 28.44l7.24-7.24L20.05 18 16 22.04Zm-6.09-8.04l-3.2 3.2 3.2 3.2L13.15 18 9.96 14Zm12.18 0l-3.19 3.2 3.19 3.2 3.2-3.2-3.2-3.2Zm-8.13 4.04-2.03-2.02 2.03-2.02 2.02 2.02-2.02 2.02Z" fill="#F3BA2F" /></svg>
                                </div>
                            </div>
                        </div>
                    </section>
